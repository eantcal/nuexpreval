...
token_t expr_tknzr_t::_next()
{
    ...
    while (!eol()) {
        ...
        if (_strtk.accept(symbol) && other.empty()) {
            ...
            if (eol()) {
                token.set_identifier(_strtk.data());
            ...
            while (!eol() && _word_op.accept(symbol)) {
                ...
                if (_word_op.keyword_matches) {
                    if (other.empty()) {
                        ...
                        token.set_identifier(_word_op.data());
